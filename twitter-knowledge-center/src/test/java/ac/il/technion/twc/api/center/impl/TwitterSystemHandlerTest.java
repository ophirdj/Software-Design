...
public class TwitterSystemHandlerTest {
  ...
  public final void importDataShouldCallStorageLoadWithEachService()
    ...
    when(serviceBuilder.getInstance(Integer.class)).thenReturn(integerValue);
  ...
  public final void loadServicesShouldCallStorageLoadWithEachService()
    ...
    when(services.iterator()).thenReturn(Arrays.asList(o1, o2, o3).iterator());
    $.loadServices();
   ...
   */
  @Test
  public final void getServiceShouldReturnLoadedValue() throws IOException {
    ...
    assertEquals(null, $.getService(Byte.class));
  }
