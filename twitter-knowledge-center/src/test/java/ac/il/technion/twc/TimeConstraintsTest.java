...
public class TimeConstraintsTest {
  ...
  // didn't import data
  private final TwitterKnowledgeCenter tkcImportData =
      new TwitterKnowledgeCenter();
  // imported data but didn't set up index
  private final TwitterKnowledgeCenter tkcSetupIndex =
      new TwitterKnowledgeCenter();
  ...
  public final void getDailyHistogram() throws Exception {
    ...
    for (int i = 0; i < 10000; ++i)
      $.getDailyHistogram();
    final long end = System.currentTimeMillis();
    assertTrue("Took " + (end - start) + " millis instead of 20",
        end - start <= 20);
  }
  ...
  /**
   * Test method for {@link TwitterKnowledgeCenter#getLifetimeOfTweets(String)}
   * 
   * @throws Exception
   */
  @Ignore
  ...
  private static String[] generateTweets(final int numBase,
    ...
    final DateFormat dateFormatter =
        TwitterKnowledgeCenter.injector.getInstance(Key.get(DateFormat.class,
