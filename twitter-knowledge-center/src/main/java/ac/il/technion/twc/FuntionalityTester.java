   ...
   */
	public FuntionalityTester() {
		serviceCenter = new TwitterSystemBuilder()
				...
				.addPropertyBuilder(TweetsRetriever.class,
						new TweetsRetrieverBuilder())
				...
				.registerService(new TagToPopularity()).getResult();
	 ...
	 * {@link FuntionalityTester#importData(String[])}. setupIndex will be
